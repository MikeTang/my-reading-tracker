  ...
  return (
    <aside className="w-56 bg-white border-r border-slate-100 flex flex-col py-6 px-4 shadow-sm flex-shrink-0">
      ...
      <nav className="flex-1 space-y-1">
        <a
          href="#"
          className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-violet-50 text-violet-700 font-medium text-sm"
        >
        ...
        <a
          href="#"
          className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-500 hover:bg-slate-50 text-sm"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
